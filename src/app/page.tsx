...
export default function Home() {
  ...
  function handleTryGuest() {
    if (typeof window !== 'undefined') {
      try {
        localStorage.setItem('guest_access', 'true');
      } catch (e) {
        console.warn('failed to set guest_access in localStorage', e);
      }
    }
    router.push('/logs');
  }
          ...
          <div className="md:flex">
            <div className="p-10 md:w-2/3">
              <h1 className="text-4xl sm:text-5xl font-extrabold leading-tight mb-4">
                メモ帳感覚で使える
                <span className="text-blue-600"> NoteArc</span>
              </h1>
              ...
              <ul className="grid gap-3 sm:grid-cols-3 mb-6">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500">メモ帳感覚で気楽に使えます</div>
                  </div>
                </li>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500">見やすい形式で振り返りに最適</div>
                  </div>
                </li>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500">タグで振り返りやすい</div>
                  </div>
                </li>
              </ul>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:items-center">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center px-5 py-3 rounded-lg border text-sm bg-gray-100 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer"
                  aria-label="ゲストで試す"
                >
                  ゲストで試す
                </button>
              ...
              <div className="w-full max-w-xs">
                <div className="rounded-lg border p-4 bg-white shadow-sm">
                  ...
                  <div className="flex gap-2 flex-wrap">
                    <span className="text-xs bg-gray-100 px-2 py-1 rounded">#nextjs</span>
